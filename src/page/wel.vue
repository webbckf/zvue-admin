<template>
  <div>
      ...
      <el-col :md="7"
        ...
        <basic-container>
          <div class="wel-info">
            ...
            <div class="user">
              <div class="user-img">
                <span style="user-title">张建玲</span>
                <div class="user-subtitle">VIP用户</div>
              </div>
              <div class="user-item">绑定机构：甘肃紫光</div>
    ...
    <basic-container>
      <avue-echart-line :option="option" :data="data1" width="100%" height="300"></avue-echart-line>
    </basic-container>
    <basic-container>
      <avue-crud :data="data" :option="tableOption">
